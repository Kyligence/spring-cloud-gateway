...
public class KylinLoadBalancerClientFilter extends LoadBalancerClientFilter
	...
	public boolean isGlobalMode() {
		return resourceGroups.containsKey(GLOBAL_RESOURCE_GROUP);
	}
	...
	protected ServiceInstance choose(ServerWebExchange exchange) {
		...
		if (isGlobalMode()
				&& Objects.nonNull(exchange.getAttribute(PROJECT_FLAG))
				&& StringUtils.isNotEmpty(exchange.getAttribute(PROJECT_FLAG))) {
